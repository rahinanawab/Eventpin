...
public class OrgEvent extends BasePage{
    ...
    private final By editEvent = By.xpath("//li[2]/parent::ul[@class='MuiList-root MuiList-padding css-h4y409-MuiList-root']//li[3]");
    ...
    public void setHamburg() throws InterruptedException {
        ...
        hamdropdown.click();
        Thread.sleep(1000);
        WebElement editorgevent = wait.until(ExpectedConditions.presenceOfElementLocated(editEvent));
        Thread.sleep(1000);
        editorgevent.click();
        Thread.sleep(1000);
    }
